...
{
    public partial class Est_Monetaria : Form
    {
        public Est_Monetaria()
        {
            InitializeComponent();
        }
        ...
        private void Est_Monetaria_Load(object sender, EventArgs e)
        {

        }

        private void Est_Monetaria_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
